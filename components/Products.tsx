  ...
  return (
    <form method='get' action={submitTarget} ref={formRef}>
      <div className='flex flex-col gap-16'>
            ...
            return (
              <div className="rounded-md bg-white text-left p-8" key={product.id}>
                ...
                <p className="my-4">
                  ...
                  {product.unitName && <span className="text-sm text-green-800"> /{product.unitName}</span>}
                </p>
                <div className="mt-1">
        ...
        <button
          className="items-center px-20 rounded-md py-2 max-w-fit self-center bg-green-900 text-white hover:scale-105 disabled:opacity-50 disabled:cursor-not-allowed"
          disabled={!enabled}
        >
          Checkout
        </button>
